...
module AssetManager {
    ...
    export function loadAssets() {
        ...
        imagesToBeLoaded = imagesToBeLoaded.filter(function (item, pos) {
            return imagesToBeLoaded.indexOf(item) === pos;
        });

        audioToBeLoaded = audioToBeLoaded.filter(function (item, pos) {
            return audioToBeLoaded.indexOf(item) === pos;
        });
